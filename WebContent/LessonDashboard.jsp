    ...
    <div class="row row-offcanvas row-offcanvas-left">
			...
			<h7>&nbsp;</h7> <!-- creates an empty space between topbar and sidebar -->
			 <ul class="nav nav-sidebar sbars">
              <li><a href="clWiz1.jsp" class="hovercolor topbar">Lesson Plan</a></li>
              <li><a href="CreateLessWiz.jsp" class="hovercolor">Read Lesson</a></li>
              <li><a href="" class="hovercolor bottombar">Update Lesson</a></li>
            </ul>
            ...
            <ul class="nav nav-sidebar sbars" style="background-color: #1A0000; border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
              <li><a href="" data-toggle="modal" data-target="#myModal" class="hovercolor topbar bottombar">Deactivate Lesson </a></li>
              	<!-- Modal -->
			...
			<div class="col-sm-9 col-md-10 main">
			  ...
			  <div class="panel panel-default">
			    <div class="panel-heading panhead">Lesson Plan Title &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Major Subjects &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Lead Lesson Title</div>
  				<div class="panel-body">
  				 Author
  				 <br>Short Description Here (250 character limit)</div>
			  </div>
			  
			  <div class="panel panel-default">
  				<div class="panel-body">Lesson Title<br>Lesson Title<br>Lesson Title<br>Lesson Title<br>Lesson Title<br>Lesson Title
			  </div>
