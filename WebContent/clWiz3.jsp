 ...
 <body>
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid" style="background-color: #8A0000;">
			...
			<div class="container">
				<h3>Select Lead Lesson</h3>
				<div class="radio">
  					<label><input type="radio" name="optradio">Lesson 1</label>
				</div>
				<div class="radio">
					  <label><input type="radio" name="optradio">Lesson 2</label>
				</div>
				<div class="radio">
					  <label><input type="radio" name="optradio">Lesson 3</label>
				</div>
				<div class="radio">
					  <label><input type="radio" name="optradio">Lesson 4</label>
				</div>
				<div class="radio">
					  <label><input type="radio" name="optradio">Lesson 5</label>
				</div>
			</div>
			
			<div class="container">
				<form role="form" method='post' action="clWiz3Controller">
